...
public class HuntBehaviour implements Behaviour {
	...
	// Class<?> refers to declaring a Class object which can be of any type
	...
	// added here.getItems() to see if there is a item the actor can pick up
	private boolean containsTarget(Location here) {
		return ((here.getActor() != null &&
				targetClass.isInstance(here.getActor())) || here.getItems() != null) ;
	}
